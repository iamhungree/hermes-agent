...
def _like_escape(s: str) -> str:
    """Escape backslashes, percent signs, and underscores for SQLite LIKE patterns."""
...
class SessionDB:
    ...
    def resolve_session_id(self, session_id_or_prefix: str) -> Optional[str]:
        ...
        escaped = _like_escape(session_id_or_prefix)
        with self._lock:
            cursor = self._conn.execute(
    ...
    def _contains_cjk(cls, text: str) -> bool:
        ...
        return any(cls._is_cjk_codepoint(ord(ch)) for ch in text)
